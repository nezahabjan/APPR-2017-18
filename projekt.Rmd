...
V spodnjem grafu je prikazana napoved gibanja deleža obolelih Slovencev, glede na gibanje od leta 2007 dalje. Napoved je prikazana preko linearne regresije in prikazuje trend upadanja deleža bolnih v Sloveniji ter s tem tudi skladno napoved za prihodnost.
...
Med moškim in ženskim spolom so opazne razlike v doseganju življenjske starosti (ženske živijo dlje) in hkrati v športni aktivnosti (moški se gibljejo več), a je pri obeh spolih viden trend: "bolj kot so v neki državi aktivni, nižja je povprečna življenjska doba", kar je zopet v nasprotju s pričakovanim. 
