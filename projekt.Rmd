...
```{r graf1, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Vpliv potrošnje za šport na število bolnih'}
...
```{r graf2, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Vpliv športne aktivnosti na življenjsko dobo'}
...
```{r zemljevid, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Zemljevid aktivnosti državljanov'}
...
```{r zemljevid, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Zemljevid življenjske dobe državljanov'}
